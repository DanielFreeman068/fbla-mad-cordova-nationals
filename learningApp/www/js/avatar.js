  ...
  function populateItems(category) {
    ...
    categoryItems.forEach((item) => {
      ...
      card.addEventListener("click", () => {
        ...
        // If this is the eyewear category, update the custom CSS class
        if (category === "eyewear") {
          eyewearLayerEl.classList.remove(
            "eyewear-cyberpunk",
            "eyewear-round",
            "eyewear-scuba",
            "eyewear-monocle"
          ...
          if (item.id === "cyberpunk" || item.id === "superhero_mask") {
            eyewearLayerEl.classList.add("eyewear-cyberpunk");
          } else if (item.id === "round_glasses" || item.id === "sunglasses") {
            eyewearLayerEl.classList.add("eyewear-round");
          } else if (item.id === "scuba_goggles") {
            eyewearLayerEl.classList.add("eyewear-scuba");
          } else if (item.id === "monocle") {
            eyewearLayerEl.classList.add("eyewear-monocle");
          }
        }

        // If this is the hats category, update the custom CSS class
        if (category === "hats") {
          hatLayerEl.classList.remove(
            "hat-beanie",
            "hat-cap",
            "hat-cowboy_hat",
            "hat-graduation_cap",
          ...
          switch (item.id) {
            case "beanie":
              hatLayerEl.classList.add("hat-beanie");
              break;
            case "cap":
              hatLayerEl.classList.add("hat-cap");
              break;
            case "cowboy_hat":
              hatLayerEl.classList.add("hat-cowboy_hat");
              break;
            case "graduation_cap":
              hatLayerEl.classList.add("hat-graduation_cap");
              break;
            case "heart_clip":
              hatLayerEl.classList.add("hat-heart_clip");
              break;
            case "magic_hat":
              hatLayerEl.classList.add("hat-magic_hat");
              break;
            case "military_helmet":
              hatLayerEl.classList.add("hat-military_helmet");
              break;
            case "pirate_hat":
              hatLayerEl.classList.add("hat-pirate_hat");
              break;
            case "plant_sprout":
              hatLayerEl.classList.add("hat-plant_sprout");
              break;
            case "spartan_mask":
              hatLayerEl.classList.add("hat-spartan_mask");
              break;
            case "sunhat":
              hatLayerEl.classList.add("hat-sunhat");
              break;
            case "tophat":
              hatLayerEl.classList.add("hat-tophat");
              break;
          }
        }
